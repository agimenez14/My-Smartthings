...
metadata {
	...
	tiles(scale: 2) {
		...
		valueTile("percentPrecip", "device.percentPrecip", inactiveLabel: false, width: 2, height: 1, decoration: "flat", wordWrap: true) {
		...
		valueTile("light", "device.illuminance", inactiveLabel: false, width: 2, height: 2, decoration: "flat", wordWrap: true) {
			state "default", label:'${currentValue}\nlux',
				backgroundColors:[
					...
					[value: 1000, color: "#ffa81e"], // 0.0079 W/m^2  per Lux
					[value: 8000, color: "#fbd41b"]
				]
		}
        valueTile("visibility", "device.visibility", inactiveLabel: false, width: 2, height: 1, decoration: "flat", wordWrap: true) {
         ...
         valueTile("ultravioletIndex", "device.ultravioletIndex", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
            state "ultravioletIndex", label: 'UV \n${currentValue}', unit: "UV Index",
				backgroundColors:[
					[value: 1, color: "#ffffff"],
					[value: 3, color: "#48ff3f"],
                    [value: 5, color: "#fff23f"],
                    [value: 7, color: "#ffa83f"],
					[value: 9, color: "#d10000"]
				]
        }
