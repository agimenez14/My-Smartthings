...
*/
metadata {
    definition (name: "WeMo AirPurifier", namespace: "RostikBor", author: "RostikBor") {
        capability "Actuator"
    ...
    tiles (scale: 2){
        multiAttributeTile(name: "status", type:"generic", width:6, height:4, canChangeIcon: true) {
            tileAttribute ("device.mode", key: "PRIMARY_CONTROL") {            		
                attributeState("Off", label:'Off', icon:"st.Appliances.appliances11", backgroundColor:"#ffffff")
                ...
                attributeState("Auto", label:'${currentValue}', icon:"st.Appliances.appliances11", backgroundColor:"#00A0DC")
            }
        ...
        standardTile("switch", "device.switch", decoration: "flat", canChangeBackground: true, width: 2, height: 2, canChangeIcon: true) {
            state "On", label:'ON', action:"fanOff", icon:"st.thermostat.fan-on", backgroundColor:"#00A0DC", nextState: "update"
            state "Off", label:'OFF', action:"fanOn", icon:"st.thermostat.heating-cooling-off", backgroundColor:"#ffffff", nextState: "update"
            state "update", label:'Wait', backgroundColor:"#b59c60"
        }

        standardTile("ionizer", "device.ionizer", decoration: "flat", canChangeBackground: true, width: 2, height: 2, canChangeIcon: true) {
            state "On", label:'ON', action:"ionizerOff", icon:"st.Lighting.light18", backgroundColor:"#00A0DC", nextState: "update"
            state "Off", label:'OFF', action:"ionizerOn", icon:"st.Lighting.light18", backgroundColor:"#ffffff", nextState: "update"
            state "update", label:'Wait', backgroundColor:"#b59c60"
        }
        ...
        standardTile("auto", "device.mode", decoration: "flat", canChangeBackground: true, width: 2, height: 2) {
            ...
            state "Auto", label: 'AUTO', action: "fanOff", icon:"st.Appliances.appliances11",backgroundColor:"#00A0DC", nextState: "update"
