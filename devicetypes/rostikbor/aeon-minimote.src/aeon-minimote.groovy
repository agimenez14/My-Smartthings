...
metadata {
	definition (name: "Aeon Minimote", namespace: "RostikBor", author: "RostikBor") {
		capability "Actuator"
		capability "Button"
	...
	tiles (scale: 2) {
    	...
    	(1..4).each { btn ->
            ...
            standardTile(tileList[index], "device.button", width: 2, height: 2) {
            	state("default", label: "", defaultState: true, backgroundColor: "#ffffff", icon: "st.unknown.zwave.remote-controller", decoration: "flat", canChangeIcon: true, canChangeBackground: true)
            }
